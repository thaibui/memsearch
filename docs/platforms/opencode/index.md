...
- **Automatic summarization** -- each captured turn is submitted to the shared `memsearch serve` service
- **No cold-start injection** -- recall is explicit and happens through the memory tools
